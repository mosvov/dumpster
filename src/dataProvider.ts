...
import { Filter } from "react-admin-amplify/build/providers/Filter";
import { Pagination } from "react-admin-amplify/build/providers/Pagination";
...
export class DataProvider {
  ...
  public getList = async <RecordType>(
    ...
    let queryName = this.getQueryName("list", resource);
    let queryVariables = {};
  ...
  public delete = async <RecordType>(
    ...
    if (previousData && previousData._version) {
  ...
  public async graphql(
   ...
   /* console.log("graphql", this.authMode)*/;
